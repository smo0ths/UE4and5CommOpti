...
r.lumen.hardwareraytracing.inline=0; def 1 lumen hardwareraytracing tracing switch test
...
r.lumen.reflections.hardwareraytracing.bucketmaterials=1; 0 for performance def 1 test
...
r.nanite.computerasterization=0; test
